...
OPTIONS
        ...
        --login
                ...
                -uid, --userid
                    user id for operations related to user

                    for practical usage, store session in a shell variable and
                    pass this variable as parameter

                -s, --session
                    user session for operations related to user. For example,
                    session id can corresponds to the cookie nammed 
                    _vinted_fr_session from host .www.vinted.fr

                    for practical usage, store session in a shell variable and
                    pass this variable as parameter

                Example:
                  vget --login -uid $vinted_uid -s $vinted_session
        ...
        -t, --thread
                ...
                Examples:
                  vget --thread 123456 -uid $vinted_uid -s $vinted_session
                  vget --t 123456 -uid $vinted_uid -s $vinted_session
        ...
        -f, --favorites
                ...
                Examples:
                  vget --favorites -l -uid $vinted_uid -s $vinted_session
                  vget --favorites -dl -uid $vinted_uid -s $vinted_session
